...
export default function StarRating({
  ...
  function handleRaiting(raiting) {
    setRaiting((raiting + 1).toFixed(1)); //array value always starts from 0 so when user click on 1st star it will be 0+1 and raiting will be 1
    //if we want to get the value of raiting in parent component
    onSetCount((raiting + 1).toFixed(1));
  }

  function handleMouseHoverIn(raiting) {
    setTempRaiting((raiting + 1).toFixed(1));
  }
